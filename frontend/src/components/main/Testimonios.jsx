...
const Testimonios = () => {
  const testimoniosData = [
    ...
    { usuario: '@delfinajalil', texto: '“Eli es una excelente entrenadora, me enseñó a corregir técnica para lograr mejores resultados además de ser una ayuda en cuestiones diariarias que hacen al logro de los objetivos es una persona con paciencia y dedicación  por su trabajo.”' },
